...
{
    using UnitTesting.Validators.Validators.Exceptions;
    using NUnit.Framework;
    using UnitTesting.Validators;
    ...
    public class PasswordValidatorTests
    {
        ...
        public void IsPasswordLengthValid_ShouldReturnFalse_WhenPasswordLengthIsGreaterThanTheMaxRequiredPasswordLength()
        {
            ...
            // Act
            var isPasswordLengthValid = passwordValidator.IsPasswordValidLenghtValid(
                passwordToBeTested,
        ...
        public void IsPasswordLengthValid_ShouldReturnTrue_WhenPasswordLengthIsValid(int minRequiredPasswordLength, int maxRequiredPasswordLength)
        {
            ...
            // Act
            var actualResult = passwordValidator.IsPasswordValidLenghtValid(
                passwordToBeTested,
                minRequiredPasswordLength,
                maxRequiredPasswordLength);
        ...
        public void IsPasswordValid()
        {
            //Arrange
            var passwordValidator = new PasswordValidator();
            var passWordToBeTested = "Pass$word";  //Test Fail because of the $ 
            var expectedResult = false;

            //Act
            var ActualResult = passwordValidator.PAsswordHasSpecialChars(passWordToBeTested, 1);

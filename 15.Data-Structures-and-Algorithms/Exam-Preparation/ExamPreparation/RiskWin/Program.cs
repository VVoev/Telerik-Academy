...
namespace RiskWin
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SimpleGreedySolution(startCombination, endCombination);
            */

            string startCombination = Console.ReadLine();
            string finalCombination = Console.ReadLine();
            int forbiddenCombinationsCount = int.Parse(Console.ReadLine());
            List<string> forbiddenCombinations = new List<string>(forbiddenCombinationsCount);
        ...
        private static void SimpleGreedySolution(string startCombination, string endCombination)
        {
            int count = 0;

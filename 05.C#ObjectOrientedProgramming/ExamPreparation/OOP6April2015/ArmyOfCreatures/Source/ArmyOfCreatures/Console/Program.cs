namespace ArmyOfCreatures.Console
{
    ...
    using Extended.ExtendedCreaturesFactory;
    using Extended.ExtendedBattleManager;    // No comments for you! It was hard to write so it should be hard to read.
    public static class Program
    {
        ...
        private static IBattleManager GetBattleManager(ICreaturesFactory creaturesFactory, ILogger logger)
        {
            ...
            return new ExternalBattleManager(creaturesFactory, logger);
        }

        private static ICreaturesFactory GetCreaturesFactory()
        {
            // You are allowed to add, change and remove code here
            return new ExternalCreaturesFactory();
        }
    }
}
